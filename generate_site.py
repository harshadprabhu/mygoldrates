...
<section class="card coin-hub-card" aria-label="24K Minted Gold Coins & Bars" style="background:var(--card);border:1px solid var(--line);border-radius:16px;padding:24px;margin:24px 0">
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px">
    <div style="background:var(--paper);border:1px solid var(--line);border-radius:12px;padding:16px;display:flex;flex-direction:column;justify-content:space-between">
      ...
      <a href="https://www.mmtcpamp.com/shop" target="_blank" rel="noopener nofollow" class="btn btn-gold" style="display:block;text-align:center;font-size:12px;padding:8px 12px;margin-top:10px">Buy MMTC-PAMP 24K &rarr;</a>
    </div>
    <div style="background:var(--paper);border:1px solid var(--line);border-radius:12px;padding:16px;display:flex;flex-direction:column;justify-content:space-between">
      <div>
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
    ...
    <div style="background:var(--paper);border:1px solid var(--line);border-radius:12px;padding:16px;display:flex;flex-direction:column;justify-content:space-between">
      ...
      <a href="https://www.candere.com/gifts/gold-coins.html" target="_blank" rel="noopener nofollow" class="btn btn-gold" style="display:block;text-align:center;font-size:12px;padding:8px 12px;margin-top:10px">Buy Kalyan 24K Bar &rarr;</a>
    </div>
    <div style="background:var(--paper);border:1px solid var(--line);border-radius:12px;padding:16px;display:flex;flex-direction:column;justify-content:space-between">
      <div>
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;text-align:left">
      ...
      <tbody>
        <tr style="border-bottom:1px solid var(--line)">
          ...
          <td style="padding:10px 8px"><a href="https://www.mmtcpamp.com/shop" target="_blank" rel="noopener nofollow" style="color:var(--gold);font-weight:600">Buy MMTC-PAMP &rarr;</a></td>
        </tr>
        <tr style="border-bottom:1px solid var(--line)">
          ...
          <td style="padding:10px 8px"><a href="https://www.candere.com/gifts/gold-coins.html" target="_blank" rel="noopener nofollow" style="color:var(--gold);font-weight:600">Buy Kalyan &rarr;</a></td>
        </tr>
        <tr style="border-bottom:1px solid var(--line)">
